...
wandb.init(name='VAE ll loss', 
           project='VAE_l1',
           notes='step lr, l1 loss', 
...
model_trainer = Trainer(model, criterion_rec, criterion_dis, dataloader_train, dataloader_val, optimizer, device='cuda', path2save=path2save)
