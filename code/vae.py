...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim):
        ...
        # self.res_block1 = ResNet_block(ch=16, k_size=3, num_groups=1)
...
class VAE(nn.Module):
    def __init__(self, latent_dim=128):
        ...
        self.z_mean = nn.Linear(256*9*8*8, latent_dim)
...
if __name__ == '__main__':
    ...
    input = torch.randn(2, 1, 137, 113, 113).to(torch.float32).to(device)
